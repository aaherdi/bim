    ...
    <div class="container-fluid">
        <div class="card card-default">
            <div class="card-header">
                <h3 class="card-title">
                    Tambahkan Stok Barang Masuk
                </h3>
                <div class="float-sm-right">
                    <a href="<?= site_url('stock/stock_in_index') ?>" class="btn btn-info btn-sm"><i class="fa fa-undo"> Kembali</i></a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 offset-md-4">
                        <form action="<?= site_url('stock/process'); ?>" method="post">
                            ...
                            <div class="form-group">
                                <button class="btn btn-success btn-flat" type="submit" name="in_add"><i class="fa fa-paper-plane"></i> Simpan</button>
                            </div>
                        </form>
                    </div>
                </div>
